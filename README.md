...
- **AI в production**: внедрение AI-ассистентов в разработку и тестирование
- **UX/UI**: доступность и пользовательский опыт
- **AI в интерфейсах**: LLM и локальные модели в UI
- **MCP-серверы**: для Claude, OpenAI, Qwen, DeepSeek
- **Developer Experience (DX)**: применение новых инструментов и процессов

## Ключевые навыки

- **Frontend**: Vue (3, Nuxt), React, TypeScript, JavaScript; Python (с AI)
- **Архитектура**: SPA, SSR (Nuxt), REST, WebSocket, Pinia, Vuex, Redux, Zustand, Router
- **LLM**: Claude, Codex, OpenCode, OpenRouter, OpenWebUI, Librechat, LM Studio
- **Стилизация**: CSS/SCSS/SASS, Tailwind, Bootstrap 5, shadcn/ui, NaiveUI, Metronic, Figma
- **Сборка**: Vite, Webpack, NPM, Git, CI/CD, Railway, Github Pages; Docker (с AI)
- **Тестирование и UX**: Sentry, Usability Testing, UED, FEED, Vue/React Devtools
